...
<span style="color:#F5B1C8">ORDINAL는 사용하면 안된다.</span> 나중에 순서가 꼬이면 장애가 일어날 수 있다. <span style="color:#F5B1C8">ORDINAL는 기본값이기 때문에 **<span style="color:#F5B1C8">필수로 STRING</span>** 으로 바꿔줘야 한다.</span>
